...
public class TripDetailsView extends LinearLayout {
    TextView mDestinationTextView, mLatitudeTextView, mLongitudeTextView, mHeadingTextView;
    ...
    private void init(Context context) {
        ...
        mDestinationTextView = (TextView) findViewById(R.id.view_trip_detail_destination_text_view);
    ...
    public void updateFromTripObject(Trip trip) {
        mDestinationTextView.setText(trip.destination);
